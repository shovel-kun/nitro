...
namespace margelo::nitro::image {
  ...
  std::shared_ptr<Promise<std::optional<double>>> JHybridTestObjectSwiftKotlinSpec::promiseReturnsNull() {
    static const auto method = javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>()>("promiseReturnsNull");
    auto __result = method(_javaPart);
    return [&]() {
